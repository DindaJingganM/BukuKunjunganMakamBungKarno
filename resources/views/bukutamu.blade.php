                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <h1 align="center">SILAHKAN ISI BUKU PENGUNJUNG</h1>

                            <div class="form-group">

                                <label for="" class="label-control">Nama Pengunjung</label>
                            ...
                            <div class="form-group">
                                ...
                                <label for="" class="label-control">Jumlah Pengunjung</label>
